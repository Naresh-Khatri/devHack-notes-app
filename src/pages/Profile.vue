  ...
  <q-page v-if="user" class="bg-white q-pa-md q-mb-md flex column items-center">
    <div style="width:750px">
      ...
      <q-card-section>
        ...
        />
        <q-btn class="q-ml-xl" label="change" @click="openDialog = true" />
        <q-btn class="q-ml-xl" label="remove" />
      </q-card-section>
      <div class="text-h4 text-bold">General</div>
      <q-card-section>
        <div class="row">
          <q-input class="col q-mr-md" label="First name" v-model="firstName" />
          <q-input class="col q-ml-md" label="Last name" v-model="lastName" />
        </div>
        <q-input label="Email" readonly v-model="user.email" />
      </q-card-section>
      <q-card-section class="flex justify-end">
        <q-btn label="Save" />
      </q-card-section>
      <div class="text-h4 text-bold">Social accouts</div>
      <q-card-section>
        <q-icon size="xl" class="q-mr-md" style="color:#3b5998 " name="fab fa-facebook">
          <q-badge rounded color="positive" floating label="✔" />
        </q-icon>
        <q-icon size="xl" class="q-mr-md" style="color:#8a3ab9 " name="fab fa-instagram">
          <q-badge rounded color="positive" floating label="✔" />
        </q-icon>
        <q-icon size="xl" class="q-mr-md" style="color:#a5a200 " name="fab fa-snapchat">
          <q-badge rounded color="positive" floating label="✔" />
        </q-icon>
        <q-icon size="xl" class="q-mr-md" style="color:#000000 " name="fab fa-github">
          <q-badge rounded color="positive" floating label="✔" />
        </q-icon>
        <q-icon size="xl" class="q-mr-md" style="color:#229ED9 " name="fab fa-telegram">
          <q-badge rounded color="negative" floating label="❌" />
        </q-icon>
        <q-icon size="xl" class="q-mr-md" style="color:#00acee  " name="fab fa-twitter">
          <q-badge rounded color="positive" floating label="✔" />
        </q-icon>
      </q-card-section>
      ...
      <div class="row" style="margin-top: 100px">
        <div class="col-3">
          <div>
            <q-img class="shadow-10" :src="user.photoURL" style="border-radius: 50%; width: 100%" />
          </div>
        </div>
        <div class="col-7">
